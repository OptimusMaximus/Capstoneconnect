...
@section('content')
    ...
    {{HTML::linkRoute('evaluation.create', 'Create New Evaluation', NULL, array('class' => 'btn btn-default pull-center', 'data-toggle' => 'tooltip','data-placement' => 'top', 'title' => 'New Evaluation Creation Page'))}}
@stop